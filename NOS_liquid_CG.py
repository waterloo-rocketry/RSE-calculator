...
class NOSLiquidCG:
    ...
    def __init__(self, i_NOS_mass_and_volume, i_constants = None):
        ...
        self.liquid_cg_m = self.calculate_liquid_cg(self.case, self.liquid_height_m,
            self.consts_m.tank_dimensions_meters, self.NOS_mass_and_volume_data.liquid_volume_m3,
...
def create_output_file(target_path = 'NOS_liquid_CG_test.csv', daq_source_path =\
